import GraphMatrix.Counting.PartitionMergeWord
...
/-- The tree certificate: a fixed matching refinement at
...
certificate; this states the construction criterion explicitly. -/
