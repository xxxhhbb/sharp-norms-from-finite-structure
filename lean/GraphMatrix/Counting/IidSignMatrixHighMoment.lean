...
The high-moment inequality is reduced here to an exact count of
...
count.  Bounding that count is the high-moment estimate. -/
...
/-- Finite counting estimate at the auxiliary dimension.  The
