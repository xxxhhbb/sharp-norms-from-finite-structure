import GraphMatrix.Counting.Bounds.PathBudgets
import GraphMatrix.Counting.PathAuxMomentShape
import GraphMatrix.IntermediateEdgeOrdering
import GraphMatrix.MengerPathAlignment

/-!
# Canonical path restriction

This module constructs the canonical left-to-right embedding of each
actual right-to-left path in a vertex-disjoint family.  It is the geometric
part of the `PathFiber` product injection.
-/
...
/-- The path-fiber product bound, with
