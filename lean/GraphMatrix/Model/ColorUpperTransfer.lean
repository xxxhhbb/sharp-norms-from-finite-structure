...
/-! # independent-color upper transfer: finite combinatorial core
...
/-- Exact unnormalized color averaging, pointwise in the ambient signs.
...
/-- equation `M_G = v^v E_color H_color`, pointwise for nonempty shapes
