import GraphMatrix.Model.ColorClassRealization
import GraphMatrix.Model.ColoredPaddingIdentity

/-! # Fixed-color matrix as a zero-padded fiber matrix
...
/-- A fixed coloring yields exactly the zero padding of the typed matrix
