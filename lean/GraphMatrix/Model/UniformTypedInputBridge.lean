...
import GraphMatrix.PartiteBoundaryMatrixMengerBound
import GraphMatrix.Counting.PartiteRealTransfer

/-! # A non-circular uniform typed input for color upper transfer
...
normalized counting convention used in the color transfer. -/
...
covering `q`.  This is a coarse bound and is not the sharp core theorem. -/
