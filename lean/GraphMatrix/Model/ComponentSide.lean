import GraphMatrix.Counting.MaxPackingBoundaryComponent

/-!
Component-side partition of the *full* graph outside a separator.
It is a combinatorial assignment of roles, not yet the set of primitive
coordinates actually observed after conditioning away active components.
-/
