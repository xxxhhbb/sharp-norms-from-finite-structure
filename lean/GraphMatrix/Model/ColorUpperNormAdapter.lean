import GraphMatrix.Model.ColorFiberTypedBridge
import GraphMatrix.Model.FixedColorExpectedNorm
import GraphMatrix.Model.GlobalColorL1

/-! # Direct color upper transfer at expected operator norm
...
/-- Direct expected-norm upper reduction: the global model is bounded
