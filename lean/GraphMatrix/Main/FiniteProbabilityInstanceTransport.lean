...
theorem main_finiteProbability_instances {Omega : Type}
...
theorem main_product_finiteProbability_instances
    {A : Type} {B : A → Type}
...
theorem main_finiteProbability_congr_instances {Omega : Type}
  ...
  subst F
  exact main_finiteProbability_instances i j E d e
