import GraphMatrix.WeightedSignTiltConcreteVariance
import GraphMatrix.WeightedSignTiltTanh
import GraphMatrix.WeightedSignTiltChebyshev

/-!
The weighted sign tilt, with the actual finite tilted distribution.
