...
/-!
# P1/primitive eta identification
...
/-- A attached role is exactly a member of P1's boundary-role finset for
...
/-- and retain the same crossing edge occurrence; only their record
...
/-- Exact pointwise identification of one eta scalar and P1's primitive
...
/-- Retype a boundary role as P2a's occurrence-aware attached role. -/
...
/-- The actual eta vectors, encoded at P1's Bool-valued effective
...
/-- Decoding the Bool interface recovers the exact eta coordinate. -/
...
/-- For an actual full edge-array sample, the second-layer coordinate made
from its rest restriction is pointwise the primitive crossing product. -/
