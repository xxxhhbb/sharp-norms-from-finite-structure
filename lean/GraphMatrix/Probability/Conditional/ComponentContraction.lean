...
/-!
# deterministic component contraction and gamma regrouping
...
Starting from the component finite contraction, this module proves the exact
`gamma * eta` regrouping used in the expansion of `partiteBoundaryMatrix`.
-/
...
The crossing products are grouped
