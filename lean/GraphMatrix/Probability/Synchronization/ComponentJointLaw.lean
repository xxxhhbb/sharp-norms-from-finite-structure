...
/-!
# exact joint sample law on the actual conditional rest cube
-/
...
/-- The pair sample belonging to one active component. -/
...
/-- Decode all component samples from one actual conditional rest sample. -/
...
/-- Every event on the full family of pair samples has its exact product-cube
