import GraphMatrix.Probability.Synchronization.LargeNArithmetic

/-! # Actual P1-to-one-component tail -/
...
internally-good complete realization has the one-component tail under its
