...
/-!
# one actual trial/component has the product sample law
-/
...
/-- Removing the fixed trial and component fields from a selected scalar
...
/-- Reindex the selected Boolean scalar family as exactly the pair sample. -/
...
/-- The pair sample obtained from the actual conditional rest cube through
the full eta family and the natural selected-coordinate equivalence. -/
...
/-- The one-component tail now holds on the actual conditional rest
