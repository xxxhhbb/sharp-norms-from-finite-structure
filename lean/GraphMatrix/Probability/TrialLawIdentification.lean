import GraphMatrix.Probability.Conditional.ComponentContraction
import GraphMatrix.Probability.Components.CrossingArrays
import GraphMatrix.Probability.Synchronization.ActualAddressBridge
...
/-- P1's internal edge arrays are exactly the component primitive block. -/
...
/-- Restriction of a complete internal realization to the existing arrays. -/
...
/-- Componentwise observables factor under the original full edge-array law.
...
/-- and use the same occurrence-preserving primitive address. -/
...
/-- Exact complete-internal conditioning for events in the actual model. -/
