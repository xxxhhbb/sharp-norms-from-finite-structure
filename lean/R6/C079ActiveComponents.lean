...
import R6.C079PartitionIntervalMonotonicity
...
def PartiteShape.c079ActiveMaximum (G : PartiteShape) : ℕ := by
  classical
...
theorem PartiteShape.c079ActiveMaximum_le_roles
    (G : PartiteShape) : G.c079ActiveMaximum ≤ G.roles := by
  classical
  unfold c079ActiveMaximum
...
theorem PartiteShape.exists_minimum_with_c079ActiveMaximum
    ...
    ∃ cut : Finset (Fin G.roles),
      G.IsMinimumRightLeftSeparator cut ∧
        G.c079ActiveComponentCount cut = G.c079ActiveMaximum := by
  classical
...
#print axioms PartiteShape.c079ComponentRoles_nonempty
#print axioms PartiteShape.c079ComponentRoles_edge_closed_outside_cut
#print axioms PartiteShape.c079ActiveComponentCount_le_roles
#print axioms PartiteShape.c079ActiveMaximum_le_roles
#print axioms PartiteShape.exists_minimum_with_c079ActiveMaximum
#print axioms PartiteShape.c079ActiveComponentCount_le_maximum
#print axioms PartiteShape.c079_boundaryFree_component_attached_of_boundaryCore
