...
/-!
# C2 contraction for every separator assignment

`P2a.componentContraction` is trial-indexed.  C2 needs the same deterministic
...
/-- Arbitrary-separator version of the actual P2a component contraction. -/
...
/-- Rest-address map for a fixed P2a scalar is injective. -/
...
/-- The C2 scalar `T_K(ω,s)` for every separator assignment. -/
...
/-- The direct original-edge monomial is exactly the P2a internal product times
...
/-- Exact compatibility requested by C2: on a P2a diagonal tuple the new
all-separator contraction is the existing P2a contraction of the restrictions
...
#print axioms componentContractionAt_eq_p2a
#print axioms frozenInternalCube_apply
#print axioms frozenRestCube_crossing_apply
#print axioms actualComponentContraction_eq_p2a
