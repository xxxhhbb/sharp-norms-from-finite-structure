import Mathlib
import R6.PaperR16SeparatorCoordinatesScratch
import R6.PaperR16LowerStackingMixed

/-!
# C2: typed primitive consistency and exact separator coefficient

This module formalizes the deterministic/combinatorial core of C2 after the
active-component arrays have been frozen and after C1 has supplied the actual
...
What is deliberately not claimed here: the current C2 package does not contain
...
namespace GraphMatrixReplica.PaperR16.C2
...
theorem actualCoefficient_norm_eq_sqrt_product
  ...
  apply GraphMatrixReplica.PaperR16.SeparatorScratch.norm_of_consistency_zero_padding_eq_sqrt_product
    er ec
...
theorem weightedFlattening_of_mixed_reindex
    ...
    (A : GraphMatrixReplica.PaperR16.lowerHeteroIndex q size →
      Matrix ι κ ℝ)
    (hReindexNorm :
      ‖GraphMatrixReplica.PaperR16.lowerMixedFlatten q size dir A‖ =
        ‖actualCoefficient Label RowOcc ColOcc w‖) :
    Real.sqrt
        ((Fintype.card (RoleAssign Label (row \ sep)) : ℝ) *
         (Fintype.card (RoleAssign Label (col \ sep)) : ℝ)) *
      ...
      Real.sqrt 3 ^ q *
        GraphMatrixReplica.PaperR16.lowerHeteroMean q size
          (fun noise =>
            ‖GraphMatrixReplica.PaperR16.lowerHeteroChaos q size A noise‖) := by
  have hStack := GraphMatrixReplica.PaperR16.lowerMixedFlatten_norm_le
    q size dir A
  rw [hReindexNorm,
...
#print axioms primitiveEncode_injective
#print axioms primitiveEncode_decode_of_consistent
#print axioms mem_range_primitiveEmbedding_iff_consistent
#print axioms glueFull_unique
#print axioms actualCoefficient_row_zero_of_inconsistent
#print axioms actualCoefficient_col_zero_of_inconsistent
#print axioms separator_eq_of_primitive_matches
#print axioms actualCoefficient_entry_same_separator
#print axioms actualCoefficient_entry_different_separator
#print axioms actualCoefficient_entry
#print axioms actualCoefficient_norm_eq_sqrt_product
#print axioms weightedFlattening_of_mixed_reindex

end GraphMatrixReplica.PaperR16.C2
