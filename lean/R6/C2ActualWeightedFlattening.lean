...
/-!
# C2 actual weighted-flattening lower bound
...
/-- The recursive heterogeneous-chaos L2-operator-norm mean on the C2 right side. -/
...
/-! ## 2. No-external-hypothesis actual C2 theorem -/
...
premises discharged internally: C1 supplies cover/intersection and C supplies
...
/-- D: final deterministic C2 lower bound with the RHS written as the finite
...
#print axioms lowerHeteroMean_eq_card_mean
#print axioms lowerHeteroMean_eq_actualFreshMean
#print axioms actualRetainedCoefficientNormProof
#print axioms actualCoefficientNormProof
#print axioms actual_weightedFlattening_lower
#print axioms actual_C2_lower_bound
