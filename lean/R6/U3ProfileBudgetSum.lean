import R6.U3ExponentLedger

/-!
U3: sum the explicit budgets over ACTUAL realizable role profiles.
This is an arithmetic theorem, not an assumed or proved count of those fibers.
In particular no fiber-cardinality hypothesis is hidden in an input record.
...
#print axioms fixedProfileBudget_le_uniform
#print axioms profileCount_mul_uniformBudget
#print axioms sum_realizable_profile_budgets_le_requested
