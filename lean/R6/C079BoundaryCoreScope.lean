...
import R6.CoveredRoleBlockBound

/-! # The no-detached-component scope of the R16 C079 count

`RoleCovered` only excludes isolated middle roles.  The R16 theorem applies
...
#print axioms PartiteShape.roleCovered_of_isBoundaryCore
#print axioms PartiteShape.EdgeWalkToBoundary.boundary_mem_of_edgeClosed
#print axioms PartiteShape.edgeClosed_nonempty_meets_boundary
