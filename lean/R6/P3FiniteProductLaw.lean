...
/-!
# P3 finite product / conditioning helpers
...
Execution status in this handoff: NOT EXECUTED (the supplied P3 package has no
`lakefile`, `lean-toolchain`, or Lean executable).
-/
...
/--
Fiber integration lemma used for the second P1 good event.
...
address formulation used in the P3 disjoint-support proof. -/
...
#print axioms p3_paperMean_dependent_coordinateProduct
#print axioms p3_finiteUniformProbability_dependent_all
#print axioms p3_finiteUniformProbability_good_fiber_lower
#print axioms p3_jointEdgeSampleRawAddressEquiv
#print axioms p3_rawAddress_ne_of_edge_ne
#print axioms p3_rawAddress_fixed_edge_injective
