import R6.WeightedSignTiltComplete
import R6.HighMomentTailMarkov
import R6.P3FiniteProductLaw

/-!
# P3: deterministic P1-to-tilt transfer and one-component tail

The theorem `p3_component_tail_from_p1_bounds` takes exactly the deterministic
information that P1 supplies on one second-layer good realization:
...
`nPow` stands for `n^k` and `logn` for `log n`.  The P3 manuscript proves,
...
/-- R6 finite-uniform version of the previous theorem. -/
...
/--
Integrate the second P1 good event, still with the complete internal
...
/-- With the P1 value `a = α/4`, the exponent constant is exactly
`96/a = 384/α`. -/
...
#print axioms p3_tilt_conditions_of_p1_bounds
#print axioms p3_threshold_square_from_log
#print axioms p3_small_scale_from_uniform_envelope
#print axioms p3_component_tail_from_p1_bounds
#print axioms p3_component_tail_after_second_good
#print axioms p3_exponent_constant_from_alpha
#print axioms p3_prefactor_constant
#print axioms p3_component_constant_form
