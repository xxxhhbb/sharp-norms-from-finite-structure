import R6.PaperR16GeometricRatioEventually
import R6.PaperR16TypedCoreLpUpperAssembly

/-! # R16 eventual typed-core `L^q` assembly
...
/-- The R16 typed-core finite-scale bound on the entire fixed logarithmic
...
#print axioms paperR16ReplicaParameter_add_one
#print axioms paperR16ReplicaParameter_pos
#print axioms paperR16_typedCore_realLpRoot_le_finiteScale_eventually
