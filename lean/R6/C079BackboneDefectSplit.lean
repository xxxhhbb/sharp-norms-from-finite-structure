...
/-! # Exact R16 backbone/off-backbone defect split

R16 Appendix D fixes a vertex-disjoint family of boundary-to-boundary paths.
...
/-- R16 Appendix D equation `delta = delta_on + D`, on an actual covered
...
#print axioms ReplicaState.c079_sum_backboneRoles_eq_sum_pathDefects
#print axioms ReplicaState.c079_totalDefect_eq_backbone_add_offBackbone
#print axioms c079StateDefect_eq_onBackbone_add_offBackbone
