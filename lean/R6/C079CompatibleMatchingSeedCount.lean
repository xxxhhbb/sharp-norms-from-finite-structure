import R6.C079FreeSeedCountNumerical
import R6.PaperRademacherPerfectMatchingEnumeration

/-!
# U1: cardinality of actual, unlabelled compatible matching seeds

Adapted from the returned U1 proof draft and checked with Lean 4.33.0.
The original return is preserved separately; source and output hashes are
recorded in the U1 integration validation run.
No additional counting, encoding or exact-recovery premise is introduced.
...
#print axioms C079U1.pair_relation_exact
#print axioms C079U1.block_relation_iff
#print axioms C079U1.encode_injective
#print axioms c079_compatibleSeed_card_le_product
#print axioms c079_compatibleSeed_card_le
