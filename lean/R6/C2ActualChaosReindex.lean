...
/-!
# C2 actual fresh-edge chaos coordinates
...
conversion between C1/C2 separator assignments and the cut-role assignment
...
/-- Convert the C1/C2 separator subtype back to the original cut-role subtype. -/
...
/-- The exact weight expected by the existing C1/C2 assignment-sum theorem. -/
...
/-- The required Boolean reversal: C1 `edgeSide=false` is a row edge, whereas
...
/-- Actual C1 row address selected by a fresh multi-index and an original
...
/-- Actual C1 column address selected by the same complete fresh multi-index. -/
...
assignment.  Boundary roles are retained by the already-proved C1 geometry. -/
...
#print axioms c1c2ToCut_cutToC1C2
#print axioms cutToC1C2_c1c2ToCut
#print axioms freshSampleNoiseEquiv
