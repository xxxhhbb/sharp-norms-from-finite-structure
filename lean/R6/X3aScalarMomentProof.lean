import R6.X3aExactPairInjection
...
namespace GraphMatrixReplica.PaperR16X3a
...
theorem even_card_of_all_occurrenceMultiplicity_even
  ...
  refine ⟨∑ k : K, half k, ?_⟩
  have hsum := GraphMatrixReplica.PaperR16X3a.sum_occurrenceMultiplicity key
  calc
    Fintype.card A = ∑ k : K,
...
end GraphMatrixReplica.PaperR16X3a
