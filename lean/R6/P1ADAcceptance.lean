import R6.P1ADUniform

/-!
# Actual P1 A--D acceptance root

These are proof-bearing declarations of the original mathematical endpoints,
not a new Prop specification. Run the pinned Lake project and inspect the
printed axiom dependencies. This delivery has not executed Lean.
-/
...
/-- Stronger acceptance endpoint: one set of constants for the whole graph. -/
...
#check @p1_D_uniform_graph
#print axioms p1_D_uniform_graph

#check @p1_A_B_C
#check @p1_D
#print axioms p1_A_B_C
#print axioms p1_D
#print axioms gamma_singleton
#print axioms gamma_of_no_internal_edges
#print axioms gamma_sq_of_empty_interior
