...
/-!
Scratch-only exact path witness supplied by a minimum separator. This is the
graph-theoretic input used in R16 lower separator flattening; it does not yet
...
#print axioms minimumSeparator_erase_not_separator
#print axioms minimumSeparator_vertex_has_sole_hit_path
