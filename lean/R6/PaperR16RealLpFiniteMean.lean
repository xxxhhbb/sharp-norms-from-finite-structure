...
/-! # Real-exponent Lyapunov step for the R16 core upper bound

The trace estimate in R16 is at an even integer order.  The requested
...
/-- The same conversion written as an `L^q` root estimate.  In R16 one
...
#print axioms paperMean_realRpow_le_of_higherMoment_budget
#print axioms paperMean_realLpRoot_le_of_higherMoment_budget
