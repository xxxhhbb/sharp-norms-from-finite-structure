...
/-!
# P1 primitive crossing-array addresses
...
Status: draft, not executed locally.  No proof of the push-forward product
law is claimed here; `P1Targets.lean` records that remaining obligation.
-/
