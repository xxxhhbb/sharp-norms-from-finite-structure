...
/-!
# P3: identify the actual P2a attachment coordinates with P1 boundary roles

This file is the first graph-specific connector from the primitive conditional
rest cube to the P1/P3 component tail.  It proves that P2a's attached roles are
...
/-- The P2a attached-role subtype and the P1 boundary-role subtype describe
...
/-- Every prescribed Boolean pattern of all actual P2a eta coordinates has the
same mass as under the uniform Boolean cube.  This is stronger than marginal
independence and is the point-mass form needed for arbitrary P1 tail events. -/
...
active component, read from the corresponding P2a crossing blocks. -/
...
/-- The actual conditional sample consumed by the P1 component tail. -/
...
#print axioms p2aAttachedRoleEquivP1Boundary
#print axioms p3DistinguishedAttachedRole
#print axioms rademacherSign_p3TrialScalarBit
#print axioms conditional_trialScalarBit_pattern_mass
#print axioms conditional_trialScalarBit_uniform_mean
#print axioms conditional_trialScalarBit_uniform_probability
#print axioms p3TrialComponentSample
